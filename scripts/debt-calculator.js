...
function addDebtRow() {
    ...
    row.innerHTML = `
        <td><input type="text" placeholder="e.g., Credit Card" class="form-control"></td>
        <td><input type="number" placeholder="e.g., 1000" class="form-control"></td>
        <td><input type="number" placeholder="e.g., 15" class="form-control"></td>
        <td><input type="number" placeholder="e.g., 50" class="form-control"></td>
